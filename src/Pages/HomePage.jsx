			...
			<Layout>
				<div className="container-body ">
					<div className="caption-body">
						<br /><br /><br /><br />
						<h1> Welcome To The <b className="text-primary">KIRTI Website</b></h1>
						<h3>Information Technology, Programming, Networking and Research <br />
							Organizations and Extracurriculars.
							-SMK N1 Gombong</h3>
						<Link to="profil"><button type="button" class="btn btn-primary">Learn More</button></Link>
						<Link to="kegiatan"><button type="button" class="btn btn-light">Get Started</button></Link>
						<br /><br /><br /><br />
					</div>
				</div>
				<div>
					<div class="container col-xxl-8 px-4 py-5">
						<div class="row flex-lg-row-reverse align-items-center g-5 py-5">
							<div class="col-10 col-sm-8 col-lg-6">
								<img src={kegiatan} class="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" width="700" height="500" loading="lazy" />
							</div>
							<div class="col-lg-6">
				...
				<div>
					...
					<div class="container px-4 py-5" id="featured-3" >
						<h2 class="pb-2 border-bottom text-center">Extracurricular Activities </h2>
